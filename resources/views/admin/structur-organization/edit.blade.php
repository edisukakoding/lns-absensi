        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <!-- Horizontal Form -->
                        <form action="{{ route('structurorganization.update', $structurorganization->id) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                                    ...
                                    <select name="employee" id="employee"
                                        ...
                                        @foreach ($employees as $employee)
                                            <option value="{{ $employee->id }}"
                                                {{ old('employee', $structurorganization->employee) == $employee->id ? 'selected' : '' }}>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="boss" id="boss" class="form-control @error('boss') is-invalid @enderror">
                                        ...
                                        @foreach ($employees as $employee)
                                            <option value="{{ $employee->id }}"
                                                {{ old('employee', $structurorganization->boss) == $employee->id ? 'selected' : '' }}>
