    ...
    <div class="container-fluid" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('population.index', []) }}">Data Penduduk</a></li>
            ...
            <div class="col-lg-6">
                <div class="card mb-4">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">Update Jumlah Penduduk</h6>
                    </div>
                    <div class="card-body">
                        <!-- Horizontal Form -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control @error('year') is-invalid @enderror" id="year"
                                        placeholder="Tahun" name="year" value="{{ old('year', $population->year) }}">
                                    @error('year')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control @error('man') is-invalid @enderror" id="man"
                                        placeholder="Pria" name="man" value="{{ old('man', $population->man) }}">
                                    @error('man')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control @error('woman') is-invalid @enderror"
                                        id="woman" placeholder="Wanita" name="woman"
                                        value="{{ old('woman', $population->woman) }}">
                                    @error('woman')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control @error('child') is-invalid @enderror"
                                        id="child" placeholder="Anak Anak" name="child"
                                        value="{{ old('child', $population->child) }}">
                                    @error('child')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control @error('baby') is-invalid @enderror" id="baby"
                                        placeholder="Bayi" name="baby" value="{{ old('baby', $population->baby) }}">
                                    @error('baby')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
